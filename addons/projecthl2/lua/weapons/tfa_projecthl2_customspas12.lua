...
SWEP.Purpose				= "A classic made in Italy." --Purpose Tooltip
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/c_customspas12.mdl" --Viewmodel path
...
SWEP.IronSightsPos = Vector(-4.332, -5.348, 1.85)
