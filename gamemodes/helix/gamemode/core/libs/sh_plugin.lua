...
function ix.plugin.Load(uniqueID, path, isSingleFile, variable)
	...
	if (!isSingleFile) then
		...
		ix.class.LoadFromDir(path.."/classes/citizens")
		ix.class.LoadFromDir(path.."/classes/rebels")
		ix.class.LoadFromDir(path.."/classes/pku")
		ix.class.LoadFromDir(path.."/classes/uon")
		ix.class.LoadFromDir(path.."/classes/ota")
		ix.class.LoadFromDir(path.."/classes/ku")
